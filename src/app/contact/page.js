      ...
      @dellysmatchups
        ...
        <section className="px-6 pb-32">
          <div className="mx-auto max-w-6xl rounded-[3rem] bg-white p-10 text-[#b30018] shadow-2xl md:p-16">
            ...
            <p className="mt-8 max-w-4xl text-xl leading-10 text-black/70">
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              ...
              <a
                ...
                className="rounded-full border border-[#b30018]/15 px-10 py-5 text-lg font-black transition hover:bg-[#b30018] hover:text-white"
              >
                Book A Session
              </a>
            </div>
